...
it('addTwoNumbers should return [7,0,8] for l1 = [2,4,3], l2 = [5,6,4]', () => {
  const l1 = [2, 4, 3];
  const l2 = [5, 6, 4];
...
it('addTwoNumbers should return [8,9,9,9,0,0,0,1] for l1 = [9,9,9,9,9,9,9], l2 = [9,9,9,9]', () => {
...
it('addTwoNumbers should return [2,1] for l1 = [2], l2 = [0,1]', () => {
  const l1 = [2];
  const l2 = [0, 1];
  const list1 = arrayToList(l1);
  const list2 = arrayToList(l2);
...
it('addTwoNumbers should return [0,2] for l1 = [1], l2 = [9,1]', () => {
  const l1 = [1];
  const l2 = [9, 1];
  const list1 = arrayToList(l1);
  const list2 = arrayToList(l2);
...
it('addTwoNumbers should return [0,0,1] for l1 = [1], l2 = [9,9]', () => {
  const l1 = [1];
  const l2 = [9, 9];
  const list1 = arrayToList(l1);
  const list2 = arrayToList(l2);
...
it('addTwoNumbers should return [5] for l1 = [2], l2 = [3]', () => {
  const l1 = [2];
  const l2 = [3];
  const list1 = arrayToList(l1);
  const list2 = arrayToList(l2);
...
it('addTwoNumbers should return [7,1] for l1 = [8], l2 = [9]', () => {
  const l1 = [8];
  const l2 = [9];
  const list1 = arrayToList(l1);
  const list2 = arrayToList(l2);
...
it('addTwoNumbers should return [2,4] for l1 = [], l2 = [2,4]', () => {
  const l1: number[] = [];
  const l2 = [2, 4];
  const list1 = arrayToList(l1);
  const list2 = arrayToList(l2);
