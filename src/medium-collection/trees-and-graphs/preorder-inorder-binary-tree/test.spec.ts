...
it('buildTree should return [3,9,20,15,7] for preorder = [3,9,20,15,7], inorder = [9,3,15,20,7]', () => {
...
it('buildTree should return [1,2,3,4,5,6,7] for preorder = [1,2,4,5,3,6,7], inorder = [4,2,5,1,6,3,7]', () => {
...
it('buildTree should return [-1] for preorder = [-1], inorder = [-1]', () => {
  const preorder = [-1];
  const inorder = [-1];
  const result = buildTree(preorder, inorder);
  const resultArray = treeNodeToArray(result);
