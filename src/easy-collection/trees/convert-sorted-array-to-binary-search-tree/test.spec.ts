...
it('sortedArrayToBST should return [0,-3,9,-10,null,5] for nums = [-10,-3,0,5,9]', () => {
...
it('sortedArrayToBST should return [0,-3,9,-10,null,5,10] for nums = [-10,-3,0,5,9,10]', () => {
...
it('sortedArrayToBST should return [-10,-3,0,5,9,10,12] for nums = [5,-3,10,-10,0,9,12]', () => {
...
it('sortedArrayToBST should return [3,1] for nums = [1,3]', () => {
  const nums = [1, 3];
  const result = sortedArrayToBST(nums);
  const resultArray = treeNodeToArray(result);
