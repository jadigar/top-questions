...
it('removeNthFromEnd should return [1,2,3,5] for head = [1,2,3,4,5], n = 2', () => {
...
it('removeNthFromEnd should return [] for head = [1], n = 1', () => {
  const head = [1];
  const n = 1;
  const list = arrayToList(head);
  const result = removeNthFromEnd(list, n);
...
it('removeNthFromEnd should return [2] for head = [1,2], n = 2', () => {
  const head = [1, 2];
  const n = 2;
  const list = arrayToList(head);
  const result = removeNthFromEnd(list, n);
...
it('removeNthFromEnd should return [1] for head = [1,2], n = 1', () => {
  const head = [1, 2];
  const n = 1;
  const list = arrayToList(head);
  const result = removeNthFromEnd(list, n);
